...
<body>
    ...
    <div class="container mx-auto frist_container">
        <h3 class="fw-normal text-start">자유게시판</h3>
    	<div class="second_container">
    		<h5>데이터베이스를 어떻게 구상해야 할지 모르겠어요</h5>
    		<div class="info_text">
    			<span>
		    		<span>임승진</span>
		    		<span> | </span>
    		...
    		<hr>
   			<div class="text_container">
            	<img src="TestShopimages/m2.png" class="rounded img-fluid d-block">
            	<p class="text-muted">
            			안녕하세요. 코테를 진행하다가 어디서 틀렸는지 모르겠어서 조언을 구하고자 합니다. 문제와 제가 작성한 코드는 다음과 같습니다.
                        문제 내 코드 class
                        Solution { public String solution(String s) { String answer = ""; // 스플릿으로 예시 문자열 배열형태로
                        반환 String[] sArr = s.spli
             	</p>     
>>>>>>> 9177ea5 add
        	</div>
        	<!-- 댓글 -->
