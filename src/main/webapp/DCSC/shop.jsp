        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">
                        중고 거래, 친구들과 함께해요. 가깝고 따뜻한 당신의 근처를 만들어요.
                    </h1>
                    <p class="lead text-muted">
                        원하는 상품을 선택하고 판매자에게 채팅을 통해 소통하세요.
                    </p>
                    <p>
                        <a href="shopWriting.jsp" class="btn btn-success my-2">글 올리기</a>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="TestShopimages/m2.png" class="img-thumbnail">
                            <div class="card-body">
                                <h4>
                                    맥북프로 m2 실버 13인치 팝니다.
                                </h4>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary"
                                            onclick="location.href='shopInfo.jsp'">보기</button>
                                    </div>
                                    <div class="text-end">
                                        <span class="card-text fw-bold m-1">900,000원 </span>
                                        <span class="text-muted">3분 전</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="TestShopimages/dog.png" class="img-thumbnail">
                            <div class="card-body">
                                <h4>
                                    오렌즈 원데이
                                </h4>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        <span class="card-text fw-bold m-1">11,000원 </span>
                                        <span class="text-muted">5분 전</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="TestShopimages/po.png" class="img-thumbnail">
                            <div class="card-body">
                                <h4>
                                    베스킨라빈스 이상해씨 피규어
                                </h4>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        <span class="card-text fw-bold m-1">12,000원 </span>
                                        <span class="text-muted">10분 전</span>
                                    </div>
                                </div>
                            </div>
                        </div>
